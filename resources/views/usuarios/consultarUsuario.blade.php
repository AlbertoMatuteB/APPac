                                        ...
                                        <li class="z-10">
                                            ...
                                            {{-- <a class="z-10 bg-white border hover:bg-gray-200 font-light text-lg py-2 px-4 block whitespace-no-wrap">
                                                <form action="/usuarios/{{$usuario['id']}}" method="post">
                                                    <input class="z-10 bg-white border hover:bg-gray-200 font-light text-lg py-2 px-4 block whitespace-no-wrap" type="submit" value="Eliminar"  onclick="return confirm('¿Eliminar Usuario?')" @click=" isModalOpen = true "/>
